...
#r_lambda_osc_u <- read_table("~/Documents/MestradoGitHub/10osc/r_lambda_upper.dat", col_names = TRUE)
#dataosc_u <- data.frame(r_lambda_osc_u)

#r_lambda_osc_l <- read_table("~/Documents/MestradoGitHub/10osc/r_lambda_lower.dat", col_names = TRUE)
#dataosc_l <- data.frame(r_lambda_osc_l)

r_lambda_osc_ll <- read_table("~/Documents/MestradoGitHub/10osc/r_lambda_lowerlower.dat", col_names = TRUE)

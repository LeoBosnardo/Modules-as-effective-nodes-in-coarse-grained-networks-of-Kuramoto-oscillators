...
data3osc_u$sigmar <- as.numeric(ifelse(data3osc_u$sigmar == "NaN", 0, data3osc_u$sigmar))
data3osc_l$sigmar <- as.numeric(ifelse(data3osc_l$sigmar == "NaN", 0, data3osc_l$sigmar))

...
khh = 2*sum(1 for u, v in G.edges() if u in mr_hi_0based and v in mr_hi_0based) / 17
kho = sum(1 for u, v in G.edges() if u in mr_hi_0based and v in officer_0based) / 17
koh = kho
koo = 2*sum(1 for u, v in G.edges() if u in officer_0based and v in officer_0based) / 17
